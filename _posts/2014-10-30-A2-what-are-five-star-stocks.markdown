...
This comparison is called the Price to Earnings ratio, or PE for short. The lower the PE ratio the cheaper the stock. So the lower the price, for the same amount of earnings, the cheaper the stock. 
